...
Board.prototype.changeStartNodeImages = function() {
  ...
  // else {
  //   document.getElementById("algorithmDescriptor").innerHTML = `infinity`;
  // }
};
